...
ax1.axvline(pd.to_datetime('2022-09-15'), color='r', linestyle='--', lw=1) # change point 
...
ax1.tick_params(axis ='y', labelcolor = color, labelsize = 18)
ax1.axvline(pd.to_datetime('2022-04-25'), color='g', linestyle='--', lw=1) 
ax1.axvline(pd.to_datetime('2022-09-27'), color='r', linestyle='--', lw=1) # change point
...
ax1.tick_params(axis ='y', labelcolor = color, labelsize = 18)
ax1.axvline(pd.to_datetime('2022-04-25'), color='g', linestyle='--', lw=1)
ax1.axvline(pd.to_datetime('2022-05-31'), color='r', linestyle='--', lw=1) # Change point 
...
color = 'tab:blue'
#ax1.set_xlabel('Weeks')
ax1.set_ylabel('Daily COVID-19 hospitalization', fontsize=20, fontweight = "bold", color = color)
ax1.bar(r.alldata_hos.Days, r.alldata_hos.Rochester_NewHosp, color = color)
#ax1.xaxis.set_major_locator(mdates.ConciseDateFormatter())
#ax1.xaxis.set_major_locator(mdates.MonthLocator())
#ax1.xaxis.set_major_formatter(mdates.DateFormatter('%b %Y'))
ax1.tick_params(axis = 'x', rotation=30, labelsize = 16)
...
ax1.tick_params(axis ='y', labelcolor = color, labelsize = 18)
ax1.axvline(pd.to_datetime('2022-04-25'), color='g', linestyle='--', lw=1)
ax1.axvline(pd.to_datetime('2022-09-15'), color='r', linestyle='--', lw=1) # change points 
...
color = 'tab:red'
ax2.set_ylabel('SARS-CoV-2 in wastewater', fontsize=20, fontweight ="bold", color = color)
ax2.scatter(r.alldata_hos.Days, r.alldata_hos.Rochester_SARS, color = color)
ax2.tick_params(axis ='y', labelcolor = color, labelsize = 18)
...
plt.savefig('Rochester_daily_Hospital_bar_scatter_cpt.png') 
# Show plot
plt.show()
```
